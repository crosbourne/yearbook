window.onload = function() {
  ...
  var profile_divs=new Array("#neil-profile","#luke-profile","#joel-profile", "#sadiq-profile","#bruno-profile","#mathieu-profile","#andres-profile","#sophie-profile","#nina-profile","#lisa-profile","#daniel-profile","#sebastian-profile","#tony-profile","#julia-profile","#ellie-profile","#rabea-profile","#alex-profile","#johanna-profile","#michael-profile","#jarkyn-profile");
 ...
 $('#johanna-portrait').mouseenter(function() {
   close_all_but('#johanna-profile');
 });
 $('#johanna-portrait').mouseleave(function() {
   close('#johanna-profile');
 });
